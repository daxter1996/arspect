...
@section('content')
    ...
    <div class="content" style="min-height: 80vh">
        ...
        <p>
            El presente Política de Privacidad establece los términos en que Arspect usa y protege la información que es
        ...
        <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente
            ...
            proporcione y podrán ser cancelados en cualquier momento.</p>
        <p>
            Arspect está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
        ...
        <p>
            Arspect se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
            momento.
        </p>
    </div>
