    ...
    <div class="card">
        <div class="card-image">
            ...
            <form class="formasdf">
                ...
                <a data-position="right" data-delay="0" data-tooltip="Eliminar"
                   class="btn-floating halfway-fab btn-large waves-effect waves-light red removeImage"><i
                            class="material-icons tiny">remove</i></a>
            </form>
        </div>
